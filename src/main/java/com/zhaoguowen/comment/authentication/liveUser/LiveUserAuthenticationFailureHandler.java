 ...
 * 后台管理登录失败处理器
 */
public class LiveUserAuthenticationFailureHandler implements AuthenticationFailureHandler {

    private ObjectMapper objectMapper;


    public LiveUserAuthenticationFailureHandler(ObjectMapper objectMapper) {
